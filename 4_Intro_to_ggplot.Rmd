...
```{r}
# Save last plot 
ggsave(filename = "ToothGrowth.png", plot = last_plot())
# Save variable
p2 <- g + geom_point() 
ggsave(filename = "ToothGrowth.png", plot = p2)
```
...
### R Colors
- hexadecimal to represent color names (#rrggbb), “00” can be interpreted as 0.0 and “FF” as 1.0
