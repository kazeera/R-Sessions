...
log2(cells_df) #log2 only works when all columns numeric
...
```
### Matrix
- matrix is table containing multiple rows and columns of vectors with the same type, which can be either numeric, character or logical.
